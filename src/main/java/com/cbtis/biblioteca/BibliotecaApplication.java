...
public class BibliotecaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		for (Libro libro : libros) {
			jdbcTemplate.update("INSERT INTO libros(titulo, autor, editorial, isbn, edicion, anio, descripcion,cantidad) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
					libro.getTitulo(), libro.getAutor(), libro.getEditorial(), libro.getIsbn(), libro.getEdicion(), libro.getAnio(), libro.getDescripcion(), libro.getCantidad());
		}
	}
